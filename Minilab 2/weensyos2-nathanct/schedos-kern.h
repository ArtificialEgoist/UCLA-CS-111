...
typedef struct process {
	...
	int p_priority;		// Process's priority (lower means more priority)
	int p_shares;		// Process's actual assigned number of shares
	int p_shareCount;	// Process's current number of shares in cycle
} process_t;
